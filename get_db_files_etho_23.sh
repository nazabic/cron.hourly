...
find /media/diana/52fcb959-8563-4bcf-b802-10cc8c198570/Diana/rsync_data_node/ethoscope_videos/023aeeee10184bb39b0754e75cef7900/ETHOSCOPE_023 -name '2016-*' -type d -exec bash -c 'cd '{}' && pwd && set -e &&
